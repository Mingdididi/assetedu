...
<main class="container mx-3 my-3">
	...
	<div class="border-top border-2 p-4">
		...
		<form:form action="/admin/user/update" method="POST" modelAttribute="user" class="validcheck" >
		  ...
		  <div class="mb-3">
            <form:label for="sys01UserEmail" class="form-label"  path="sys01UserEmail">사용자Email</form:label>
            <form:input type="email" class="form-control" path="sys01UserEmail" placeholder="사용자이메일 입력" required="true" />
          </div>
           <div class="mb-3">
            <form:label for="sys01UserTel" class="form-label"  path="sys01UserTel">사용자연락처</form:label>
            <form:input type="tel" class="form-control" path="sys01UserTel" placeholder="사용자연락처 입력" required="true" />
          </div>    
